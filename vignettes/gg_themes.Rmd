...
gg <- ggplot(mtcars, aes(x = wt, y = mpg, label = rownames(mtcars))) +
      geom_text(aes(colour = factor(cyl))) + ggtitle("Text")
gg
```
...
gg <- ggplot(diamonds, aes(x = price, colour = color)) +
      geom_freqpoly(binwidth = 1000) + ggtitle("Frequency Polygon")
gg
```
...
gg <- ggplot(diamonds_small, aes(x = depth, fill = cut)) +
      geom_density(alpha = 0.2) + ggtitle("Density")
gg
```
...
gg <- ggplot(mtcars, aes(x = factor(cyl), y = mpg)) +
      geom_violin(aes(fill = factor(cyl))) + ggtitle("Violin")
gg
```
...
gg <- ggplot(mtcars, aes(x = mpg, y = wt, colour = factor(cyl))) +
      geom_point() +
      facet_grid(vs ~ am, scales = "free") + ggtitle("Facet Grid")
gg
```
...
gg <- ggplot(diamonds, aes(x = carat, y = price, colour = cut)) +
      geom_point() +
      facet_wrap(~ color) + ggtitle("Facet Wrap")
gg
```
